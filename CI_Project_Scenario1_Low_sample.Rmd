...
avg_relative_biases_low <- data.frame(
  missing_percentage = numeric(),
  imputation_method = character(),
...
for (missing_prob in missing_percentages) {
  ...
  coverage_probs_low <- rbind(coverage_probs_low, data.frame(
  ...
  avg_relative_biases_low <- rbind(avg_relative_biases_low, data.frame(
    missing_percentage = missing_prob,
