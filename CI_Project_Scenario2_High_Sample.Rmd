...
med_avg_relative_biases <- data.frame(
  missing_percentage = numeric(),
  imputation_method = character(),
...
for (missing_prob in missing_percentages) {
  ...
  med_coverage_probs <- rbind(med_coverage_probs, data.frame(
  ...
  med_avg_relative_biases <- rbind(med_avg_relative_biases, data.frame(
    missing_percentage = missing_prob,
